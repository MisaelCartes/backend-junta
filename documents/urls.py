...
from .views import get_family_members,create_certificate_request,get_certificate_requests_user,get_certificate_requests_admin,change_status_certificate
urlpatterns = [
